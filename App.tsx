    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col md:flex-row overflow-hidden relative">
      ...
      <div className="md:hidden flex items-center justify-between p-4 bg-slate-900 border-b border-slate-800 z-20">
        <div className="flex items-center gap-2">
            ...
            <h1 className="font-bold text-lg tracking-tight">Mnemonica<span className="text-indigo-400">Trainer</span></h1>
        </div>
      ...
      <aside className="w-full md:w-80 md:h-screen bg-slate-900 md:border-r border-slate-800 p-6 flex flex-col gap-8 z-10 overflow-y-auto">
        <div className="hidden md:flex items-center gap-2 mb-2">
           ...
           <h1 className="font-bold text-2xl tracking-tight">Mnemonica<span className="text-indigo-400">Trainer</span></h1>
        </div>
        ...
        <div className="flex-1 space-y-8">
            ...
            <div className="hidden md:block">
                 <div className="bg-slate-800/50 rounded-xl p-6 border border-slate-700/50">
                    <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-4">Keyboard Shortcuts</h3>
                    <ul className="space-y-3 text-sm text-slate-300">
                        <li className="flex justify-between"><span className="bg-slate-700 px-2 py-0.5 rounded text-xs font-mono">Space</span> <span>{practiceMode === 'timer' ? 'Play / Pause' : 'Flip Card'}</span></li>
                        <li className="flex justify-between"><span className="bg-slate-700 px-2 py-0.5 rounded text-xs font-mono">→</span> <span>Next Card</span></li>
                        <li className="flex justify-between"><span className="bg-slate-700 px-2 py-0.5 rounded text-xs font-mono">←</span> <span>Prev Card</span></li>
                    </ul>
                 </div>
            </div>
        </div>
      ...
      <main className="flex-1 h-[calc(100vh-60px)] md:h-screen relative flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center p-4 relative">
             ...
             <div className="absolute inset-0 overflow-hidden pointer-events-none flex items-center justify-center">
                 <div className="w-[500px] h-[500px] bg-indigo-600/10 rounded-full blur-3xl absolute -top-20 -right-20"></div>
                 <div className="w-[400px] h-[400px] bg-emerald-600/5 rounded-full blur-3xl absolute -bottom-20 -left-20"></div>
             </div>
        </div>

        {/* Bottom Controls */}
        <div className="w-full p-6 md:p-8 z-20">
            <Controls 
                isPlaying={isPlaying}
